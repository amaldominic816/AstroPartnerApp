                    ...
                    itemBuilder: (context, index) {
                      return Bounce(
                        ...
                        onPressed: () {
                          ...
                          updateLocale(index, homeController, context);
                          Get.back();
                        },
                        child: Container(
...
void updateLocale(
    int index, HomeController homeController, BuildContext context) {
  Locale newLocale;
  switch (index) {
    case 0:
  ...
  refreshIt(homeController);
}

void refreshIt(HomeController homeController) async {
